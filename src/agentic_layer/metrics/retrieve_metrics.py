...
- retrieve_method: vector_search, id_lookup, keyword_search, hybrid
...
Labels:
- retrieve_method: keyword_search, vector_search, hybrid, rrf, agentic
- stage: keyword_search, vector_search, embedding, milvus_search, rerank, rrf_fusion
...
def record_retrieve_request(
    ...
    Args:
        ...
        retrieve_method: Retrieval method (vector_search, id_lookup, keyword_search, hybrid)
...
def record_retrieve_stage(
    ...
    Args:
        retrieve_method: Retrieval method (keyword_search, vector_search, hybrid, rrf, agentic)
        stage: Retrieval stage (keyword_search, vector_search, embedding, milvus_search, rerank, rrf_fusion)
...
def record_retrieve_error(
    ...
    Args:
        retrieve_method: Retrieval method (keyword_search, vector_search, hybrid, rrf, agentic)
        stage: Stage where error occurred (keyword_search, vector_search, embedding, milvus_search, rerank, rrf_fusion)
